...
terapkan_efek(kartu(hitam, mimic)) :-
    ...
    ;
        ...
        ( JenisAksi == skip -> pilihWarnaBaru, pindahGiliran, pindahGiliran
        ; JenisAksi == reverse -> pilihWarnaBaru, ubahArah, urutan_pemain(LP), get_length(LP, Len), (Len =:= 2 -> pindahGiliran, pindahGiliran ; pindahGiliran)
        ; JenisAksi == drawtwo -> pilihWarnaBaru, pindahGiliran, giliran_sekarang(Korban), ambil_n_kartu(Korban, 2), pindahGiliran
